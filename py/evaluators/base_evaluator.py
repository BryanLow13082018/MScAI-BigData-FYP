...
# from customDatasetCombined import CustomDatasetCombined
...
class BaseEvaluator:
    ...
    def prepare_dataset(self, data, max_length=128):
        ...
        Returns:
            CustomDatasetCombined: A dataset ready for evaluation.
        """
        return CustomDatasetCombined(data, self.tokenizer, max_length)
    '''
